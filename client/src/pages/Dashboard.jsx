...
import {
    ...
    CalendarOff, Target, Sparkles, Activity, PanelLeftClose, PanelLeft, Sun, Moon, FileText, Brain, UserCog, Layers, Contact
} from 'lucide-react';
                ...
                <aside className="sidebar-modern scrollbar-dark" style={{
                    ...
                    <div style={{ flex: 1, padding: sidebarCollapsed ? '3.5rem 0.5rem 1rem' : '3.5rem 0.75rem 1rem' }}>
                        ...
                        <div style={{ marginBottom: '1.5rem' }}>
                            ...
                            <NavItem icon={Contact} label="CRM" href="/clients" collapsed={sidebarCollapsed} />
